...
export default function SideBar({ sections }: { sections: any[] }) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <button  onClick={handleDownloadPDF} className="w-full hover:cursor-pointer bg-blue-600 text-white py-2 rounded-lg font-bold hover:bg-blue-700 transition-colors">
        Download PDF
      </button>
